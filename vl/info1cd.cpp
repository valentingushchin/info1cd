...
Info1Cd::IDXRET Info1Cd::getStreamDataIndexes_8_3_8(const quint32 streamIndex,
                        QVector<quint32>& dataIndexes, quint64& objectLength)
{
        dataIndexes.clear();
...
Info1Cd::SIGNRET Info1Cd::detectTableSignature_8_2_14(const QByteArray &block, const quint32 offset) const
{
        ...
        if (!((block.at(offset +  2) == '"') && (block.at(offset +  3) == 0) &&
              (toupper(block.at(offset +  4)) == 'C') && (block.at(offset +  5) == 0) &&
              (toupper(block.at(offset +  6)) == 'O') && (block.at(offset +  7) == 0) &&
              (toupper(block.at(offset +  8)) == 'N') && (block.at(offset +  9) == 0) &&
              (toupper(block.at(offset + 10)) == 'F') && (block.at(offset + 11) == 0) &&
              (toupper(block.at(offset + 12)) == 'I') && (block.at(offset + 13) == 0) &&
              (toupper(block.at(offset + 14)) == 'G') && (block.at(offset + 15) == 0))) {
                return SIGNRET::VOID;
        }
        if ((block.at(offset + 16) == '"') && (block.at(offset + 17) == 0)) {
                return SIGNRET::CONFIG;
        }
        if ((toupper(block.at(offset + 16)) == 'S') && (block.at(offset + 17) == 0) &&
            (toupper(block.at(offset + 18)) == 'A') && (block.at(offset + 19) == 0) &&
            (toupper(block.at(offset + 20)) == 'V') && (block.at(offset + 21) == 0) &&
            (toupper(block.at(offset + 22)) == 'E') && (block.at(offset + 23) == 0) &&
...
Info1Cd::SIGNRET Info1Cd::detectTableSignature_8_3_8(const QByteArray &block, const quint32 offset) const
{
        ...
        if (!((block.at(offset + 1) == 0x22) &&
              (toupper(block.at(offset + 2)) == 'C') &&
              (toupper(block.at(offset + 3)) == 'O') &&
              (toupper(block.at(offset + 4)) == 'N') &&
              (toupper(block.at(offset + 5)) == 'F') &&
              (toupper(block.at(offset + 6)) == 'I') &&
              (toupper(block.at(offset + 7)) == 'G'))) {
                return SIGNRET::VOID;
        }
        if (block.at(offset +  8) == 0x22) {
                return SIGNRET::CONFIG;
        }
        if ((toupper(block.at(offset +  8)) == 'S') &&
            (toupper(block.at(offset +  9)) == 'A') &&
            (toupper(block.at(offset + 10)) == 'V') &&
            (toupper(block.at(offset + 11)) == 'E') &&
